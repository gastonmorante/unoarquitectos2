...
const outputDir = 'd:\\Uno arquitectos\\public\\projects\\residencial';
...
const images = [
  { file: 'media_1786244328910.jpg', out: 'alux-7cielos-ocean-pool.jpg' },
  { file: 'media_1786244328575.jpg', out: 'alux-7cielos-living-open.jpg' },
  { file: 'media_1786244329111.jpg', out: 'alux-7cielos-chukum-suite.jpg' },
  { file: 'media_1786244339927.jpg', out: 'alux-7cielos-studio-parota.jpg' },
  { file: 'media_1786244339959.jpg', out: 'alux-7cielos-master-jungle-view.jpg' },
];

async function processResidentialImages() {
  for (const imgInfo of images) {
    ...
    console.log(`Saved clean residential image to: ${outputPath}`);
  }
}

processResidentialImages().catch(console.error);
