    ...
    <div id="app-root" className="min-h-screen w-full overflow-x-hidden bg-background text-gris-texto selection:bg-arena-calida selection:text-white font-sans transition-colors duration-300 texture-overlay">
      ...
      <a
        href={`https://wa.me/5219842108420?text=${encodeURIComponent(
          isEs 
            ? "Hola UNO Arquitectos, me interesa recibir asesoría técnica para un proyecto en Riviera Maya." 
            : "Hello UNO Arquitectos, I would like technical advice for a project in Riviera Maya."
        )}`}
        target="_blank"
        rel="noopener noreferrer"
        aria-label={isEs ? "Contactar por WhatsApp a UNO Arquitectos" : "Contact UNO Arquitectos via WhatsApp"}
        className="fixed bottom-6 left-6 z-40 bg-[#25D366] hover:bg-[#20ba5a] text-white p-3.5 rounded-full shadow-2xl transition-all duration-300 hover:scale-110 flex items-center justify-center min-w-[50px] min-h-[50px] focus:outline-none focus-visible:ring-2 focus-visible:ring-[#25D366] focus-visible:ring-offset-2 cursor-pointer"
      >
