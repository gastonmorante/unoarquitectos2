    ...
    digitalLogbook: [
      {
        ...
        keyMilestones: [
          ...
          "Tendido de canalizaciones para escenas de iluminación sensorial 2700K",
          "Conexión de biodigestores anaeróbicos y humedales de PTAR",
          "Levantamiento fotográfico y 360° oficial en Google Drive"
        ],
        personnelOnSite: "16 Técnicos especialistas en MEP, Climas Daikin e Iluminación Lutron",
        inspectedBy: "Ing. Especialista en MEP & Arq. Angel Cereceda",
        driveFolderUrl: "https://drive.google.com/drive/folders/1l0jp1jiRCOXMMI6sjqweEwhXh0BPkxPU?usp=drive_link",
      ...
      },
      {
        ...
        labTestsAndQuality: [
          ...
          "Comprobación de humedad en madera de Tzalam (< 10% higrometría)",
          "Prueba de estanqueidad por 72h con marcador milimétrico en alberca cenote",
          "Levantamiento oficial 360° esférico con 19 puntos HD"
        ],
        keyMilestones: [
          "Terminación de Chukum en muros de doble altura de estancia principal",
          "Instalación y pulido apomazado de placas de mármol Santo Tomás",
          "Perfilado de bordes orgánicos de alberca cenote con pasta turquesa",
          "Habilitado de bastidores de Tzalam en taller propio de Tulum"
        ],
        personnelOnSite: "28 Artesanos mayas de Chukum, marmoleros, ebanistas y supervisores",
        inspectedBy: "Arq. Angel Cereceda & Residente General de Obra",
        driveFolderUrl: "https://drive.google.com/drive/folders/1CgBZbtS-CHUvISmdfnmg3TPKJIwNXV4n?usp=drive_link",
        photographicLogUrl: "https://drive.google.com/drive/folders/1SKrAecbj22oz23ZIjAWoeK2p8zENDTM7?usp=drive_link",
        scenes360Count: 19,
        photosCount: 20
      }
