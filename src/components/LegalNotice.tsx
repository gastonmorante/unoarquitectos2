              ...
              {activeTab === "privacy" ? (
                ...
                <div className="space-y-4 text-left">
                  ...
                  <h4 className="font-headline-md font-bold text-teal-uno text-sm uppercase">
                    ...
                    <p>
                      {language === "es"
                        ? "Las estimaciones, presupuestos paramétricos, listas de materiales sugeridos y conceptos generados por nuestro Asesor IA (Planner) tienen carácter estrictamente preliminar e informativo. No constituyen un contrato ni una cotización vinculante hasta la realización formal del estudio geotécnico de suelo kárstico, proyecto ejecutivo y firma de contrato formal."
                        : "Estimations, parametric budgets, material recommendations, and architectural suggestions generated by our AI Advisor are strictly preliminary and informational. They do not constitute a binding contract or quote until formal geotechnical karst soil studies, executive blueprints, and formal agreements are executed."}
                    </p>
